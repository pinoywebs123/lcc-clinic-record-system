...
<body>
    ...
    <content>
    	...
    	<table border="1" style="margin-top: 50px; border-collapse: collapse; width: 100%">
            ...
            <tbody>
                <tr>
                    <td>{{$find->employee_clinic->date_time}}</td>
                    <td>{{$find->employee_clinic->nurse_assesment}}</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
        ...
        <table border="1" style="margin-top: 20px; border-collapse: collapse; width: 100%">
            ...
            <tbody>
                <tr>
                    <td>{{$find->employee_clinic->date_time}}</td>
                    <td>{{$find->employee_clinic->action_taken}}</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
    	...
    	<footer>
    		<p>School Nurse</p>
    		<p>{{$find->employee_clinic->school_nurse}}</p>
    	</footer>
    </content>
</body>
</html>