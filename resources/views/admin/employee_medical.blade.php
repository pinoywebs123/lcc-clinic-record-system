...
@section('contents')
	...
	<form action="{{route('medical_employee_view_create',Request::segment(3))}}" method="POST">
	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<a href="{{route('medical_employee_view',Request::segment(3))}}" class="btn btn-default btn-sm">CLEAR</a>
			</div>	
	</div>
